...
local skills = {
    ...
    xi.skill.SHIELD,
    xi.skill.PARRY,
    xi.skill.DIVINE_MAGIC,
    xi.skill.HEALING_MAGIC,
    xi.skill.ENHANCING_MAGIC,
    xi.skill.ENFEEBLING_MAGIC,
    xi.skill.ELEMENTAL_MAGIC,
    xi.skill.DARK_MAGIC,
    xi.skill.SUMMONING_MAGIC,
    xi.skill.NINJUTSU,
    xi.skill.SINGING,
    xi.skill.STRING_INSTRUMENT,
    xi.skill.WIND_INSTRUMENT,
    xi.skill.BLUE_MAGIC,
    xi.skill.GEOMANCY,
    xi.skill.HANDBELL
}
...
m:addOverride('xi.player.charCreate', function(player)
    ...
    for _, v in pairs(xi.wsUnlock) do
        player:addLearnedWeaponskill(v)
    end
